...
for (let i = 0; i < arr2.length; i++) {
    console.log(arr2[i]); // inside each element array
}
...
console.log(arr6); // returning [2,4,6,8,10]
...
function find(array, value) {
    ...
    for (let i = 0; i < array.length; i++) {
        if (array[i] === value) {
            return true; // stops the function and returns true
        }
    }
